        ...
        <div id="targetElement" class="xxx:w-full xl:w-[550px] lg:w-[450px] lg:h-full">
            <section class="">
                ...
                <nav
                    ...
                    @foreach($tripTab as $tk => $tv)
                        <button
                            class="text-black tabutton h-full  ss:py-1 xxx:w-[19.5%] xxs:w-[18.8%] {{--us-420:w-[18%]  lg:w-[18%]--}}  bg-[#b8cac9] rounded-t-lg  {{ $tk == 'recent' ? 'active' : '' }} group element  hover:shadow-md transition-all transform duration-300 ease-out relative"
                            data-bs-toggle="tab"
                            data-bs-target="#{{$tv}}"
                            role="tab"
                            aria-controls="{{$tv}}"
                            aria-selected="{{ $tk == 'recent' ? 'true' : 'false' }}">
