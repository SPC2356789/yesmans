...
@section('content')
    ...
    <div
        ...
        <div id="tab" class="lg:h-full" data-trip_tab='@json($tripTab)' data-trip_data='@json($tripData)'></div>
...
{{--                        <div class="flex flex-row justify-between  fade  {{ $tabK == 'recent' ? 'active show' : '' }} " id="{{$tabK}}"--}}
...
{{--                                <div class="w-full h-full Itinerary" id="tripCarousel" data-carousel='@json($data)'></div>--}}
{{--                                <div class="swiper Itinerary relative">--}}
{{--                                    <div class="swiper-wrapper tab-lock">--}}
{{--                                        <div class="bg-white z-10 absolute w-full h-full opacity-0"></div>--}}
{{--                                        @foreach($data as $dataUUid => $tripTime)--}}
{{--                                        <img class="swiper-slide" src="{{Storage::url($Media[$tripTime['trip']['carousel'][0]]) }}"--}}
{{--                                             data-lock="{{$dataUUid}}"/>--}}
{{--                                        @endforeach--}}
{{--                                    </div>--}}
{{--                                    <div--}}
