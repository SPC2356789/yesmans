...
@section('content')
    <div class=" py-12 w-full">
        ...
        <div class="space-y-10">
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-4">一、隱私權保護政策的適用範圍</h2>
                <p class="text-gray-600 leading-relaxed">
                    隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。
                </p>
            </section>
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-4">二、個人資料的蒐集、處理及利用方式</h2>
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-4">三、資料之保護</h2>
                <p class="text-gray-600 leading-relaxed">
                    只由經過授權的人員才能接觸您的個人資料，如因業務需要有必要委託其他單位提供服務時，本網站亦會嚴格要求其遵守保密義務，並且採取必要檢查程序以確定其將確實遵守。
                </p>
            </section>
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-4">四、網站對外的相關連結</h2>
                <p class="text-gray-600 leading-relaxed">
                    本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。
                </p>
            </section>
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-4">五、與第三人共用個人資料之政策</h2>
                <p class="text-gray-600 leading-relaxed mb-2">
                    本網站絕不會提供、交換、出租或出售任何您的個人資料給其他個人、團體、私人企業或公務機關，但有法律依據或合約義務者，不在此限。
                </p>
                <p class="text-gray-600 leading-relaxed mb-2">前項但書之情形包括不限於：</p>
                <ul class="list-disc list-inside text-gray-600 leading-relaxed space-y-2">
                    <li>經由您書面同意。</li>
                    <li>法律明文規定。</li>
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-4">六、Cookie之使用</h2>
                <p class="text-gray-600 leading-relaxed">
                    為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的Cookie，若您不願接受Cookie的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕Cookie的寫入，但可能會導至網站某些功能無法正常執行。
                </p>
            </section>
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-4">七、隱私權保護政策之修正</h2>
                <p class="text-gray-600 leading-relaxed">
