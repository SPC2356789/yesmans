                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="all-name" id="all-name" autocomplete="name"
                                       class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-[#64A19D] sm:text-sm/6">
                            </div>
                        </div>
...
{{--                        </div>--}}
            ...
            <div
                class="inline-flex items-center cursor-pointer text-gray-600 hover:text-[#64A19D] active:scale-95 transition-transform duration-200 ease-in-out"
                name="add_number">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button type="submit"
                        class="rounded-md bg-[#64A19D] px-3 py-2 text-sm font-semibold  hover:text-[#64A19D] text-neutral-50 shadow-sm hover:bg-neutral-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#64A19D]">
                    Save
                </button>
            </div>
